...
function showFullAnnonce(annonce) {
    ...
    <div class="details">
        <p><img class="icon" src="icon/liste-de-controle.png"><strong>Marque</strong><br>${annonce.marque_vehi.charAt(0).toUpperCase()}${annonce.marque_vehi.substring(1).toLowerCase()}</p>
        <p><img class="icon" src="icon/auto.png"><strong>Modèle</strong><br>${annonce.model_vehi}</p>
        ...
        <p><img class="icon" src="icon/moteur.png"><strong>Puissance DIN</strong><br>${annonce.puissance_din_vehi} Kw</p>
        <p><img class="icon" src="icon/liste-de-controle.png"><strong>Cylindrée</strong><br>PROCHAINEMENT</p>
        ...
        <br><br><hr><br><br>
        <h3>Contact :</h3><br>
        <p><img class="icon" src="icon/liste-de-controle.png"><strong>Numéro de téléphone</strong><br>${annonce.numero_telephone}</p><br>
