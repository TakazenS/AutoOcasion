...
<html lang="fr-FR">
    <head>
        ...
        <link rel="stylesheet" href="/public/pages/MentionLegal/PageMentionLegal.css">
        <link rel="stylesheet" href="/includes.css">
        <title>AUT'OCCASION - Mentions Légales</title>
    </head>
    <body class="bg-light">
        ...
        <script src="/public/pages/MentionLegal/PageMentionLegal.js"></script>
    </body>
</html>